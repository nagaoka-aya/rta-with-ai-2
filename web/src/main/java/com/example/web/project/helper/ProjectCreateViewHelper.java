...
import com.example.web.project.dto.create.ClientDto;
import com.example.web.project.mapper.ProjectCreateMapper;

/**
 * プロジェクト登録機能のViewHelper。
 *
 * @author sample
 */
@Component
...
public class ProjectCreateViewHelper {
    ...
    public String getClientName(Integer clientId) {
        ...
        try {
            ...
            LoggerFactory.getLogger(ProjectCreateViewHelper.class).info(e.getMessage()); //サンプルではログ出力するにとどめる
            return null;
        }
    }
