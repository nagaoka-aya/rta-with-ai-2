...
/**
 * 期間内プロジェクト一括出力バッチで出力するCSVファイルとマッピングするItem。
 */
public class ExportProjectsInPeriodItem {

    /**
     * {@link Project}を元に{@link ExportProjectsInPeriodItem}を生成する。
     * @param project 元となる{@link Project}
     * @return {@link Project}の値をコピーした{@link ExportProjectsInPeriodItem}
     */
