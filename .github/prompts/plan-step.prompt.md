...
5. **動作確認:**  
   - 実装した機能が正しく動作するかを確認するためのテストケースを作成してください。
   - テストケースは実際にブラウザにアクセスして確認する手順を具体的に記載してください。
   - このケースはAI AgentがPlaywrightを用いて実行します。AIに伝わるように記載してください。
