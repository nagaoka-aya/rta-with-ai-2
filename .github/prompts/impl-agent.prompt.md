...
# Technical Foundation: Environment Detail
動作確認手順
1. アプリは常に起動しています。ホットデプロイが有効になっているため、コードを修正して保存すると自動的に再起動されます。
2. playwright mcpでテストを実行
3. ログイン画面が表示された場合はユーザID：10000001、パスワード：pass123-でログイン
